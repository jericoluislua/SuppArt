...
class DefaultController
{
    ...
    public function index()
    {
        ...
        $view->title = 'SuppArt';
        $view->heading = 'Thats a cool site! This is some random ass text just to keep this middle part a bit interesting with some information which would be terminated from your brain while you read';
        $view->subtitle = '';
        $view->display();
    }
}
